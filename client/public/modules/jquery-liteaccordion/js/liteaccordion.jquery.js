...
; (function ($) {
    ...
    var LiteAccordion = function (elem, options) {
        ...
        var defaults = {
            ...
            containerHeightOffset: 0,               // maximum width the accordion will resize to
            ...
            onBeforeTriggerSlide: function () { },    // callback on before slide activate
            ...
            core = {
                ...
                setSlideWidth: function (width) {
                    ...
                    slideWidth = width - slideLen * settings.headerWidth;
                ...
                responsive: function () {
                    ...
                    if (!$(document.body).hasClass("mini-navbar")) {
                        if (window.innerWidth - settings.containerWidthOffset > settings.minContainerWidth) {
                            settings.containerWidth = window.innerWidth - settings.containerWidthOffset;
                        } else {
                            settings.containerWidth = settings.minContainerWidth;
                        }

                    } else {
                        if (window.innerWidth - 140 > settings.minContainerWidth) {
                            settings.containerWidth = window.innerWidth - 140
                        } else {
                            settings.containerWidth = settings.minContainerWidth;
                        }
                    ...
                    settings.containerHeight = (window.innerHeight - settings.containerHeightOffset) > 400 ? (window.innerHeight - settings.containerHeightOffset) : 400;
                ...
                triggerSlide: function (e) {
                    if (!settings.onBeforeTriggerSlide($(this))) {
                        return;
                    }
                    var $this = $(this),
                        tab = {
                ...
                init: function () {
                    $("#accordeon").data("coreInstance", core);
